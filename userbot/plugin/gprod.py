#made by @Royal_Boy_45 with shivansh#made by @Royal_Boy_45 with shivansh#made by @Royal_Boy_45 with shivansh#made by @Royal_Boy_45 with shivansh#made by @Royal_Boy_45 with shivansh#made by @Royal_Boy_45 with shivansh#made by @Royal_Boy_45 with shivansh#made by @Royal_Boy_45 with shivansh#made by @Royal_Boy_45 with shivansh
marculs=9
...
async def get_full_user(event):  
    ...
    if event.reply_to_msg_id and not len(args) == 2:
        ...
        try:
            ...
            return await event.edit("Error... Please report at @Black_Snake_Userbot_Support", str(err))           
