...
#
#hehehhe
#Making The Back Command Was The Toughest Work #by @Shivam_Patel,@The_Siddharth_Nigam,@Royal_Boy_45,@Royal_king7 also v changed Pop up or inline help to text
...
# 🇨 🇭 🇦 🇱 🇴      🇸 🇮 🇷    🇵 🇱 🇪 🇦 🇸 🇪    🇬 🇪 🇹 🇴 🇺 🇹    
    ...
    async def opner(event):
            if event.query.user_id == bot.uid :
                ...
                await event.edit("`>>>\n\nReopened The Main Menu of \n© BLACKSNAKE` ", buttons=dc)
            else:
                reply_pop_up_alert = "Please get your own Userbot,for more info visit @Black_Snake_Userbot!"
  ...
  #       🇮 🇹 🇳 🇦    🇰 🇾 🇺   🇸 🇵 🇾     🇰 🇷    🇷 🇭 🇪     🇭 🇴      🇸 🇭 🇦 🇦 🇩 🇮    🇰 🇷 🇳 🇮    🇭    🇰 🇾 🇦   🇧 🇸 🇩 🇰 
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid:  # pylint:disable=E0602
            ...
            Cobra = "Please get your own Userbot, and don't use mine for more info visit @Black_Snake_Userbot!"
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid:  # pylint:disable=E0602
            ...
            await event.edit(buttons=dc)
              ...
              TheDark = "Please get your own Userbot😁😁,for more info visit @Black_Snake_Userbot! 😎😎"
 ...
 #hehehehehhehhehhehe   
    ...
    async def on_plug_in_callback_query_handler(event):
        if not event.query.user_id == bot.uid:
            atul= "Please get your own Userbot😁😁,for more info visit @Black_Snake_Userbot! 😎😎"
        ...
        try:
            if event.query.user_id == bot.uid :
                ...
                reply_pop_up_alert = "Please get your own Userbot, and don't use mine for more info visit @Black_Snake_Userbot!"
...
#  🇦 🇷 🇪      🇧 🇸 🇩 🇰      🇮 🇸 🇸 🇪    🇰 🇦 🇳 🇬  🇲 🇦 🇹   🇰 🇷    🇷 🇪   🇲 🇨 
                    ...
                    try:
                        ...
                        await event.edit( "`Your Blacksnake Has Successfully loaded` >>>" + str(event.data_match.group(1).decode("UTF-8")),buttons=fcix)
